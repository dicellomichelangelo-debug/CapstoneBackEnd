...
public class JWTAuthFilter extends OncePerRequestFilter {
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) throws ServletException {
        ...
        boolean isAuthRoute = new AntPathMatcher().match("/api/auth/**", path);
        boolean isGetProducts = new AntPathMatcher().match("/api/products/**", path) && method.equals("GET");
        boolean isGetCategories = new AntPathMatcher().match("/api/categories/**", path) && method.equals("GET");

        return isAuthRoute || isGetProducts || isGetCategories;
    }
}